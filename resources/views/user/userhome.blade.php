...
@section('content')
    <section id="hero">
        <h2 style="margin-bottom: 10px">The Biggest <span class="h2 text-warning">Jobseeker Website</span> In Myanmar</h2>
    </section>
    {{-- login section --}}
    <section id="login">
        <div class="container">
    ...
    <section class=" px-6 py-3">
        <div id="about-us" class="container mt-5">
            ...
            <div class="row">
                <div class="col-7" style=" padding: 100px 10px">
                ...
                <div class="col-5" style="height: 300px">
                    <img src="{{ asset('img/cvjob1.jpg') }}" alt="" class="w-100">
                </div>
