        ...
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="">
                                    ...
                                    @else
                                        <div>
                                            <img src="{{ asset('userImage/' . Auth::user()->img) }}" alt="Cool Admin"
                                                class=" img-thumbnail " />
                                        </div>
                                    @endif
                                </div>
            ...
            <div class="col-md-2">
                ...
                <div class="card w-100 mt-2">
                    ...
                    <div class="card-body">
                        <div class="card-text">
                            <a href="{{ route('user#alertMessagePage') }}">
                                <button class="btn btn-sm btn-danger mx-2" type="submit">Message</button>
                            </a>
                        </div>
                    </div>
                </div>
