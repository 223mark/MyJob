        ...
        <div class="card w-50 py-4 bg-light">
            <div class="mb-4 d-flex justify-content-end">
                <a href="{{ route('employer#info') }}">
                    <button class="btn btn-dark me-4 my-2
                ">Back</button>
                </a>
            </div>
            ...
            <form action="{{ route('employer#changePassword') }}" method="POST">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button class="btn btn-sm btn-danger w-100 " type="submit">Change</button>
                </div>
            </form>
        </div>
    </div>
